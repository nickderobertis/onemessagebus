...
pub const CAPABILITIES: &[Capability] = &[
    Capability {
        ...
        bindings: &[REGISTRY, CONFIG, bind("format", FlagKind::Value("--format"))],
        uncovered: &[],
    },
    Capability {
        method: "schemaCheck",
    ...
    Capability {
        method: "send",
        verb: &["send"],
        options: Some("send_options"),
        stdout: StdoutShape::Jsonl("sent"),
        stdin: true,
    ...
    Capability {
        ...
        stdout: StdoutShape::Json("claimed"),
        stdin: false,
        library_entry: "onemessagebus::RawQueue::claim",
        bindings: &[
            bind("queue", FlagKind::Positional),
            bind("consumer", FlagKind::Value("--consumer")),
    ...
    Capability {
        method: "reply",
        verb: &["reply"],
        options: Some("reply_options"),
        stdout: StdoutShape::Json("replied"),
        stdin: true,
        library_entry: "onemessagebus::Bus::reply",
        bindings: &[
            bind("queue", FlagKind::Positional),
            bind("position", FlagKind::Positional),
            bind("correlation", FlagKind::Value("--correlation")),
            bind("file", FlagKind::Value("--file")),
            CONFIG,
            TRANSPORT_DIR,
            REGISTRY,
    ...
    Capability {
        method: "subscribe",
        verb: &["subscribe"],
        options: Some("subscribe_options"),
        stdout: StdoutShape::Jsonl("log_record"),
        stdin: false,
        library_entry: "onemessagebus::RawQueue::wait_for_change",
        bindings: &[
            bind("queue", FlagKind::Positional),
            bind("until", FlagKind::Value("--until")),
            bind("timeout", FlagKind::Value("--timeout")),
            bind("format", FlagKind::Value("--format")),
            CONFIG,
            TRANSPORT_DIR,
            REGISTRY,
    ...
    Capability {
        ...
        stdout: StdoutShape::Json("queue_statuses"),
        stdin: false,
    ...
    Capability {
        method: "transports",
        verb: &["transports"],
        options: Some("transports_options"),
        stdout: StdoutShape::Json("transport_kinds"),
        stdin: false,
    ...
    Capability {
        method: "ask",
        verb: &["ask"],
        options: Some("ask_options"),
        stdout: StdoutShape::Json("asked"),
        stdin: true,
        library_entry: "onemessagebus::Bus::ask",
        bindings: &[
            bind("queue", FlagKind::Positional),
            bind("blocking", FlagKind::Switch("--blocking")),
            bind("asker", FlagKind::Value("--asker")),
            bind("about", FlagKind::Value("--about")),
            bind("timeout", FlagKind::Value("--timeout")),
            bind("correlation", FlagKind::Value("--correlation")),
            bind("file", FlagKind::Value("--file")),
            CONFIG,
    ...
    Capability {
        method: "schemas",
        verb: &["schemas"],
        options: Some("schemas_options"),
        stdout: StdoutShape::Json("schema_cache"),
        stdin: false,
    ...
    Capability {
        method: "schemasClear",
        verb: &["schemas", "clear"],
        options: Some("schemas_clear_options"),
        stdout: StdoutShape::Json("schemas_cleared"),
        stdin: false,
    ...
    Capability {
        method: "schemasFetch",
        verb: &["schemas", "fetch"],
        options: Some("schemas_fetch_options"),
        stdout: StdoutShape::Json("schemas_fetched"),
        stdin: false,
        library_entry: "onemessagebus::LinkResolver::resolve",
        bindings: &[
            bind("links", FlagKind::Positional),
            CONFIG,
            bind("format", FlagKind::Value("--format")),
        ],
        uncovered: &[],
...
const CONFIG: OptionBinding = bind("config", FlagKind::Value("--config"));

/// The directory overriding the configuration's transport directory.
const TRANSPORT_DIR: OptionBinding = bind("transportDir", FlagKind::Value("--transport-dir"));

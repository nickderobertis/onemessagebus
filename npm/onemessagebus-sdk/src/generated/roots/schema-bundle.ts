...
const $RegistryDocument: z.ZodType = z.strictObject({
  id: z.lazy(() => $SchemaId),
...
const $LayoutDocument: z.ZodType = z.strictObject({
...
export const SchemaBundleSchema = contract<SchemaBundle>(
  z.strictObject({
    version: z.lazy(() => $BundleVersion),
    description: anyOf([z.string(), z.null()]).optional(),
    schemas: z.array(z.lazy(() => $RegistryDocument)),
    layouts: z.array(z.lazy(() => $LayoutDocument)).optional(),
  }),
);

 ...
 */
export interface AgentEventEnvelopeV2 {
  /**
...
export const AgentEventEnvelopeV2Schema = z.looseObject({
  v: z.literal(2),
  ts: z.string(),
  stream: z.string(),
  seq: z.int().gte(0),
...
}) as unknown as z.ZodType<AgentEventEnvelopeV2>;

/** `agent.event-envelope@2`, as the Rust registry holds it. */
export const AgentEventEnvelopeV2 = registeredMessage(
